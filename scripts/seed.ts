...
async function seed() {
  ...
  const services = await Service.create([
    { name: 'Residential Pest Control', slug: 'residential-pest-control', category: 'Residential', description: 'Safe home pest management', basePrice: 1200, icon: 'home' },
    { name: 'Commercial Pest Control', slug: 'commercial-pest-control', category: 'Commercial', description: 'Pest solutions for businesses', basePrice: 3500, icon: 'building' },
    { name: 'Termite Control', slug: 'termite-control', category: 'Specialist', description: 'Termite inspection and treatment', basePrice: 5000, icon: 'bug' },
    { name: 'Rodent Control', slug: 'rodent-control', category: 'Rodent', description: 'Rodent trapping and proofing', basePrice: 1800, icon: 'mouse' },
    { name: 'Mosquito & Fumigation', slug: 'mosquito-fumigation', category: 'Mosquito', description: 'Mosquito fogging and fumigation', basePrice: 1500, icon: 'cloud' },
    { name: 'Bed Bug Treatment', slug: 'bed-bug-treatment', category: 'Specialist', description: 'Bed bug heat and chemical treatment', basePrice: 4000, icon: 'bed' },
    { name: 'Cockroach & General Pest Control', slug: 'cockroach-control', category: 'General', description: 'Cockroach and general pests', basePrice: 900, icon: 'cockroach' },
    { name: 'Agricultural Pest Advisory', slug: 'agri-advisory', category: 'Agriculture', description: 'Crop pest advisory and treatment', basePrice: 2500, icon: 'leaf' }
  ])
  ...
  const technicians = await Technician.create(techUsers.map(u => ({ userId: u._id, availability: [{ day: 'Mon-Fri', from: '09:00', to: '18:00' }], rating: 4.6 })))
