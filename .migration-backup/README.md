...
This repository is a full-stack Next.js 14 (App Router) TypeScript project scaffold for Utkal Pest Control — a pest-control booking application for local businesses and residents.
...
- Replace middleware with Clerk's official middleware and server-side checks.
