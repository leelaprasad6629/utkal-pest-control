...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary via-primary to-primary/95">
      ...
      <section className="flex items-center justify-center text-center text-white px-4 py-24 sm:py-32">
        <div className="max-w-3xl mx-auto space-y-5">
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs sm:text-sm font-semibold uppercase tracking-wider">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 space-y-10 sm:space-y-12">
        {/* Feature Badges */}
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm font-medium">
          <div className="flex items-center gap-1.5 bg-white/10 border border-white/20 text-white px-4 py-2 rounded-lg">
        ...
        <section className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="hover:border-primary/40 transition-colors shadow-lg bg-white border-0">
        ...
        <section className="max-w-2xl sm:max-w-3xl mx-auto w-full">
          <Card className="shadow-xl border-0 rounded-2xl overflow-hidden bg-white">
            <CardHeader className="p-6 sm:p-8 bg-muted/40 border-b border-border/60 text-center">
        ...
        <section className="max-w-3xl mx-auto pb-4">
          <Card className="border-0 bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 text-center shadow-lg">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-white mb-3">
              <Globe className="w-6 h-6" />
            </div>
            <h3 className="text-base font-semibold text-white">Nationwide Service Network</h3>
            <p className="mt-1.5 text-sm text-white/70 max-w-sm mx-auto">
